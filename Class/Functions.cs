...
namespace QLBS.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=.\SQLEXPRESS;AttachDbFilename=" + Application.StartupPath + @"\QuanLyBanSach.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True";
            Con.Open(); 
